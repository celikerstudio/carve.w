...
| [0011](./0011-de-cockpit-bedient-de-campagnes.md) | De cockpit bedient de campagnes | Twee handelingen in de cockpit, pauzeren/hervatten en dagbudget, allebei achter een knop met een verplichte verwachting die meteen als `wijziging` het journaal in gaat. Schrijven leeft in een eigen module achter een eigen `META_WRITE_TOKEN`. Meta eerst, journaal daarna. Geen automatisch ingrijpen. | Voorgesteld 2026-09-10 |
